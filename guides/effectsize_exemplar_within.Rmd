...
In this example, there are 6 subjects (`id` column).
...
Not all subjects behave the same way. Some people might be tired, bad at the task, or just not trying very hard. These performance differences can't be directly measured, but they can substantially impact the results. Here, we'll simulate individual differences by giving each subject a random performance multiplier.
